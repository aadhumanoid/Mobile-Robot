            ...
            try:
                ...
                if esp32_command:
                    if esp32_command == "VoiceON":
                        print("\n🟢 ESP32 SIGNAL: VoiceON - Mulai recording mode")
                        recording_mode = True
                        print("   Sistem siap merekam suara...")
                        
                    elif esp32_command == "VoiceOFF":
                        print("\n🔴 ESP32 SIGNAL: VoiceOFF - Stop recording mode")
                        recording_mode = False
                        controller.voice_mode_active = False
                        controller.send_to_esp32("BERHENTI")
                        print("   Kembali ke mode menunggu signal...")
                        continue
                ...
                if recording_mode:
                    ...
                    if command:
                        ...
                        if is_activation:
                            ...
                            recording_mode = False  # Exit recording mode
